        ...
        <section className="productView">
            ...
            <div className="container mt-4">
                <div className="row align-items-center justify-content-center">
                    {/* Imagen del producto */}
                    <div className="col-lg-6 col-md-4 mb-4 text-center">
                    ...
                    <div className="col-lg-6 col-md-8 mb-4">
                        ...
                        <div className="row align-items-center justify-content-center justify-content-md-start"> {/* Control de alineación */}
                            <div className="col-md-1 mb-3 mb-md-0"> {/* Establece el ancho para dispositivos de tamaño medio */}
                            <HeartStraight size={32}/>
                            </div>
                            <div className="col-md-7"> {/* Establece el ancho para dispositivos de tamaño medio */}
                                <button className="btn btn-primary rounded-pill px-4 w-100">Comprar</button>
                            </div>
                        </div>
                    </div>
                </div>
