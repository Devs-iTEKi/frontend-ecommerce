            ...
            <div className="container mt-4">
                <div className="row align-items-center justify-content-center">
                    ...
                    <div className="col-lg-8 col-md-8 mb-4">
                        ...
                        <div className="row align-items-center justify-content-center justify-content-md-start text-center"> {/* Control de alineación */}
                            <div className="col-md-2 mb-3 mb-md-0 "> {/* Establece el ancho para dispositivos de tamaño medio */}
                            <HeartStraight size={32} className="addFavorite"/>
                            </div>
